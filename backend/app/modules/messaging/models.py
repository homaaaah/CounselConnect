...
class Conversation(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("appointment_id", name="uq_conversations_appointment"),
    ...
    appointment_id: Mapped[int | None] = mapped_column(
        BIGINT(unsigned=True),
        ForeignKey("appointments.appointment_id", name="fk_conversations_appointment", ondelete="RESTRICT", onupdate="CASCADE"),
    )
    ...
    student_joined_at: Mapped[object | None] = mapped_column(DATETIME6)
    counselor_joined_at: Mapped[object | None] = mapped_column(DATETIME6)
    closure_reason: Mapped[str | None] = mapped_column(String(32))
    last_sequence_number: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False, server_default="0")
...
class Message(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("conversation_id", "sequence_number", name="uq_messages_sequence"),
    ...
    sequence_number: Mapped[int] = mapped_column(BIGINT(unsigned=True), nullable=False)
