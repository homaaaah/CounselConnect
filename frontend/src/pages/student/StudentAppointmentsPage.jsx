  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-8 text-slate-800 sm:px-6">
    <div className="mx-auto max-w-5xl space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500">Your guidance appointment history, including cancellations and Counselor decisions. Philippine time (Asia/Manila).</p>
